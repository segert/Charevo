...
$(document).ready(function () {
    ...
    {
        sessionStorage.setItem("firstPage", "the Level 5 Beauty Quiz");
        sessionStorage.setItem("memory", "the Level 5 Beauty Quiz");
        sessionStorage.setItem("currentPage", "the Level 5 Beauty Quiz");
    }
    else
    {
        if (sessionStorage.getItem("currentPage") !== "the Level 5 Beauty Quiz")
        {
            sessionStorage.setItem("memory", sessionStorage.getItem("memory").toString() + ", the Level 5 Beauty Quiz");
        }
        sessionStorage.setItem("currentPage", "the Level 5 Beauty Quiz");
    ...
    function dialoguechange() {
        if (question === 0)
        {
            if (dialogue === 1)
            {
                $("#dialogue").html("<b>Beauty:</b> Hey. So you're about to take the quiz for the novella, This Title is False (or I am true). If you enjoyed the story, have fun putting your knowledge to the test. If you haven't read it, then what on Earth are you doing here!? Spoilers lie ahead, silly. What are you expecting? If you're okay, feel free to continue.");
            }
            else if (dialogue === 2)
        ...
        else if (question === 18)
        {
            if (sessionStorage.getItem("Cyhack") === "true")
            {
                if (dialogue === 1)
                {
                    ...
                    {
                        sessionStorage.setItem("highscore", "0 out of 17");
                    ...
                    if (correct === 15)
                        ...
                        $("#dialogue").html("<b>Beauty:</b> Looks like you got a score of " + correct + " out of 17.");
                    else
                ...
                else if (dialogue === 2)
                {
                    ...
                    $("#dialogue").html("<b>Cyhack:</b> Heh heh heh heh. Let's fix that, shall we?");
                }
                else if (dialogue === 3)
                {
                    correct = 0;
                ...
                else if (dialogue === 4)
                {
                    ...
                    document.getElementById("nextlevel1a").disabled = true;
                    $("#backquiz").show();
                    $("#dialogue").html("<b>Cyhack:</b> Think you can improve on your failure? Try again by going back to the quiz menu and do a different one. You have the best of the Cyhack's wishes for more lousy luck, loser.");
                }
            ...
            else
            {
                ...
                if (sessionStorage.getItem("highscore") === null)
                {
                    sessionStorage.setItem("highscore", correct + " out of 17");
                    sessionStorage.setItem("highscoredecimal", (correct / 17));
                }
                else
                {
                    if (parseFloat(sessionStorage.getItem("highscoredecimal")) < (correct / 17))
                    {
                        sessionStorage.setItem("highscore", correct + " out of 17");
                        sessionStorage.setItem("highscoredecimal", (correct / 17));
                    }
