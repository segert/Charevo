...
function commentaryDialogueFunc()
{
    switch (commentaryDialogue)
    {
        case(0):
            ...
            {
                case(1):
                    document.getElementById("d").innerHTML = bendyBold + "Hey, cool! She can transform into Chris Farley too.";
                    break;
            }
    }
}
    ...
    switch (riffDialogue)
    {
        case(0):
            ...
            switch (dialogue)
            {
                case(1):
                    if((character === "Tel-E"))
                        document.getElementById("d").innerHTML = teleBold + "So I see you've ";
                    else if((character === "Pyra"))
